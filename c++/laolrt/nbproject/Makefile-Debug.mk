...
${OBJECTDIR}/laol/rt/exception.o: laol/rt/exception.cxx
	${MKDIR} -p ${OBJECTDIR}/laol/rt
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../../xyzzy/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/laol/rt/exception.o laol/rt/exception.cxx

${OBJECTDIR}/laol/rt/istream.o: laol/rt/istream.cxx
	${MKDIR} -p ${OBJECTDIR}/laol/rt
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../../xyzzy/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/laol/rt/istream.o laol/rt/istream.cxx
...
${OBJECTDIR}/laol/rt/lambda.o: laol/rt/lambda.cxx
	${MKDIR} -p ${OBJECTDIR}/laol/rt
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../../xyzzy/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/laol/rt/lambda.o laol/rt/lambda.cxx
...
${OBJECTDIR}/laol/rt/map.o: laol/rt/map.cxx
	${MKDIR} -p ${OBJECTDIR}/laol/rt
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../../xyzzy/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/laol/rt/map.o laol/rt/map.cxx

${OBJECTDIR}/laol/rt/ostream.o: laol/rt/ostream.cxx
	${MKDIR} -p ${OBJECTDIR}/laol/rt
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../../xyzzy/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/laol/rt/ostream.o laol/rt/ostream.cxx

${OBJECTDIR}/laol/rt/range.o: laol/rt/range.cxx
	${MKDIR} -p ${OBJECTDIR}/laol/rt
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../../xyzzy/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/laol/rt/range.o laol/rt/range.cxx
...
${OBJECTDIR}/laol/rt/exception_nomain.o: ${OBJECTDIR}/laol/rt/exception.o laol/rt/exception.cxx 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -I../../../xyzzy/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/laol/rt/exception_nomain.o laol/rt/exception.cxx;\
	else  \
...
${OBJECTDIR}/laol/rt/istream_nomain.o: ${OBJECTDIR}/laol/rt/istream.o laol/rt/istream.cxx 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -I../../../xyzzy/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/laol/rt/istream_nomain.o laol/rt/istream.cxx;\
	else  \
...
${OBJECTDIR}/laol/rt/lambda_nomain.o: ${OBJECTDIR}/laol/rt/lambda.o laol/rt/lambda.cxx 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -I../../../xyzzy/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/laol/rt/lambda_nomain.o laol/rt/lambda.cxx;\
	else  \
...
${OBJECTDIR}/laol/rt/map_nomain.o: ${OBJECTDIR}/laol/rt/map.o laol/rt/map.cxx 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -I../../../xyzzy/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/laol/rt/map_nomain.o laol/rt/map.cxx;\
	else  \
...
${OBJECTDIR}/laol/rt/ostream_nomain.o: ${OBJECTDIR}/laol/rt/ostream.o laol/rt/ostream.cxx 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -I../../../xyzzy/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/laol/rt/ostream_nomain.o laol/rt/ostream.cxx;\
	else  \
...
${OBJECTDIR}/laol/rt/range_nomain.o: ${OBJECTDIR}/laol/rt/range.o laol/rt/range.cxx 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -I../../../xyzzy/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/laol/rt/range_nomain.o laol/rt/range.cxx;\
	else  \
